export interface SetrabesUnit {
  ...
  publicServed: string;
  riskProfile: string;
  category: 'Sede' | 'Acolhimento' | 'Segurança Alimentar' | 'Especializada' | 'Logística';
  sourceUrl: string;
}

export const setrabesUnits: SetrabesUnit[] = [
  {
    id: '0.2.1',
    name: 'SEDE SETRABES',
    address: 'Av. Mário Homem de Melo, 2310, Mecejana, Boa Vista - RR',
    function: 'Gestão central de políticas de assistência, trabalho e renda.',
  ...
  },
  {
    ...
    function: 'Intermediação de mão de obra e seguro desemprego.',
  ...
  },
  {
    ...
    function: 'Acolhimento institucional de crianças em situação de risco.',
  ...
  },
  {
    ...
    function: 'Acolhimento de mulheres em situação de vulnerabilidade extrema.',
  ...
  },
  {
    ...
    function: 'Acolhimento institucional para o público feminino.',
  ...
  },
  {
    ...
    function: 'Acolhimento institucional para o público masculino.',
  ...
  },
  {
    ...
    function: 'Acolhimento temporário de curta duração.',
  ...
  },
  {
    ...
    function: 'Custódia e ressocialização de adolescentes em conflito com a lei.',
  ...
  },
  {
    ...
    function: 'Atendimento a pessoas com deficiência e necessidades especiais.',
  ...
  },
  {
    ...
    function: 'Promoção do envelhecimento ativo e acolhimento de idosos.',
  ...
  },
  {
    ...
    function: 'Sede dos conselhos estaduais (Direitos Humanos, Idoso, Criança).',
  ...
  },
  {
    ...
    function: 'Atendimento integrado a mulheres vítimas de violência.',
  ...
  },
  {
    ...
    function: 'Atendimento integrado a crianças e adolescentes vítimas de violência sexual.',
  ...
  },
  {
    ...
    function: 'Reabilitação biopsicossocial utilizando cavalos.',
  ...
  },
  {
    ...
    function: 'Centro de atendimento social em área de vulnerabilidade urbana.',
  ...
  },
  {
    ...
    function: 'Centro de Atendimento ao Cidadão e serviços sociais.',
  ...
  },
  {
    ...
    function: 'Unidade de apoio provisório para migrantes e crianças.',
  ...
  },
  {
    ...
    function: 'Divisão de Serviços Gerais e Manutenção.',
  ...
  },
  {
    ...
    function: 'Depósito Central de Materiais.',
  ...
  },
  {
    ...
    function: 'Segurança Alimentar e Nutricional.',
  ...
  },
  {
    ...
    function: 'Coordenação Geral de Logística do Estado.',
